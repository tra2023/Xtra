...
/**
 * Game details screen as a full-Compose scaffold: collapsing banner, tabs and
 * sort row on top, one shared nested-scroll system underneath (no View
 * CoordinatorLayout interop). The fragment stays the host for navigation,
 * dialogs, launchers and ViewModels; tab ViewModels are parent-scoped by key.
 */
@OptIn(ExperimentalMaterial3Api::class)
class GamePagerFragment : PagedListFragment(), Scrollable, StreamsSortDialog.OnFilter, VideosSortDialog.OnFilter {
